# MMF_AttributeByCameraDistance
This is a simple tool to create an attribute based on camera distance which will return a value between 0 and 1. This can be useful to generate falloffs or even remeshing based on camera distance.
